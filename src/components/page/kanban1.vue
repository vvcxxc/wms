 ...
 * @Author: Tao
 * @LastEditors: Tao
 * @LastEditTime: 2021-01-18 10:54:58
-->
<template>
     ...
     <div class="kanban_conter float">
        ...
        <div class="kanban_right right">
            <div class="kanban_right_top">
                ...
                <div class="kanban_name_value value6">站台1</div>
...
export default {
    ...
    methods:{
        init(){
            ...
            this.$axios({       
                    method: 'get',
                    url: `${this.$store.state.dailog.url1}/KanBanManager/KB_FenJian/GetKanBanDataByStationNo?StationNo=1`,
                    StationNo:"1"
                }).then(res => {
                    ...
                    console.log('this.data接口数据==>',this.data)
        ...
        tableRowClassName({row, rowIndex}) {
            console.log('row==>',row._BillState)
            if(row._BillState == '3'){
