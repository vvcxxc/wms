 ...
 * @Author: Tao
 * @LastEditors: Tao
 * @LastEditTime: 2021-01-18 10:56:41
-->
<template>
     ...
     <div class="kanban_conter float">
        ...
        <div class="kanban_right right">
            <div class="kanban_right_top">
                ...
                <div class="kanban_name_value value6">站台3</div>
...
export default {
    ...
    methods:{
        init(){
            ...
            this.$axios({       
                    method: 'get',
                    url: `${this.$store.state.dailog.url1}/KanBanManager/KB_FenJian/GetKanBanDataByStationNo?StationNo=3`,
                    StationNo:"3"
                }).then(res => {
